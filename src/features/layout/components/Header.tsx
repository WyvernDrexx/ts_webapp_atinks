...
function Header() {
  return (
    <div className={cn('pl-8', 'h-[auto]', 'flex items-center')}>
      ...
      <div className='ml-5 basis-5/12'>
        <div
          className={cn(
            'w-[589px] pl-3 rounded-xl flex items-center',
            'bg-[#eff2f9]'
          )}
        >
          ...
          <input
            type='text'
            id='first_name'
            className='ml-3 outline-none dark:focus:ring-blue-500 dark:focus:border-blue-500 bg-[#eff2f9] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  '
            placeholder='Search'
            required
          />
        </div>
